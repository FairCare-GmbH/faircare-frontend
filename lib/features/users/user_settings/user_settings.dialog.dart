                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      leading: SmallCircularRatingWidget(
                          rating: state is RatingsDataLoaded
                              ? state.ratings.getAverageRating()
                              : null),
                      onTap: () {
                    ...
                    ListTile(
                      ...
                      horizontalTitleGap: 0,
                      leading:
                          const Icon(Icons.settings, color: FCColors.darkGrey),
                      onTap: () async {
                        pop(context);
                    ...
                    ListTile(
                      ...
                      contentPadding:
                          const EdgeInsets.symmetric(horizontal: 12),
                      horizontalTitleGap: 0,
                      leading: const Icon(Icons.lock, color: FCColors.darkGrey),
                      onTap: () {},
                    ),
                    ListTile(
